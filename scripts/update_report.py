...
META_BOARD=re.compile(r"昨日|涨停|连板|ST|预盈|融资融券|深股通|沪股通|百元股|机构重仓|基金重仓|MSCI|标准普尔|证金持股|AH股|次新股|破净股|低价股|高送转|转债标的|HS300|沪深300|深成|深证|上证|中证|大盘股|小盘股|权重股|富时|成份|风格|周期股|高贝塔|低波")
